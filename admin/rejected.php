...
//        var_dump($_SESSION['admin']);
        if($qr=mysqli_query($conn,"select * from booking where status='Rejected'")){
...
<head>
    ...
    <title>My Ride | Admin Rejected Request</title>
    <!-- Custom CSS -->
...
<!--                    </li>-->
    ...
    <div class="page-wrapper">
        <h1 style="margin-top: 20px; text-align: center">Rejected Booking Requests</h1>
        <!-- ============================================================== -->

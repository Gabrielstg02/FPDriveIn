...
<head>
    ...
    <title>My Ride | Admin Routes</title>
    <!-- Custom CSS -->
...
<!--                    </li>-->
    ...
    <div class="page-wrapper">
        <h1 style="margin-top: 20px; text-align: center">Routes - Search Edit and Remove</h1>
        <!-- ============================================================== -->
...
<!--                                                    <button class="btn-outline-info" placeholder="Some" value="car" name="book" type="button" data-toggle="modal" data-target="#staticBackdrop">Edit this Route</button>-->
                                                ...
                                                <td style="vertical-align: middle">
                                                    <form method="post" action="functionalities/remove-route.php" id="remove-form<?php echo $rid?>">
                                                        <?php $arr = [
                                                            'rid' => $rid
                                                        ];
                                                        ?>

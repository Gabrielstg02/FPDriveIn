                ...
                <div class="row justify-content-center">
                    <div class="col-xl-8">
                        ...
                        <div class="font-back-tittle mb-45">
                            ...
                            <h3 class="archivment-back">Our Heroes</h3>
                        </div>
                    </div>
                </div>
                <?php
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                    ...
                    <div class="single-room mb-50" style="width: 70%;height: 70%">
                        ...
                        <div class="room-caption">
                            ...
                            <div class="per-night">
                                <span><u></u> <?php echo $row['gender']?> <span> </span></span>
                            </div>
                        </div>
                    </div>
                </div>
                <?php
                if(($count+1)%3==0 || $count==(mysqli_num_rows($drivers)-1)){
                    ?></div><?php
                }
                $count++;
            }
...
<!--							</div>-->
<!--							&lt;!&ndash; For Gradient Border Use &ndash;&gt;-->

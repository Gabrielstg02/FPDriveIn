            ...
            <div class="col-lg-8 mb-5 mb-lg-0">
                ...
                <form method="post">
                    <table cellpadding="20px" style="margin-left: 10%; font-size: large">
                        <tr>
                            <td>User ID: </td>
                            <td>
                                <input type="number" name="phno" placeholder="Enter Your PhoneNumber" required>
                            </td>
                        </tr>
                        <tr>
                            <td>Password: </td>
                            <td>
                                <input type="password" name="lic" placeholder="Enter Your Password" required>
                            </td>
                        </tr>
                        <tr>
                            <td></td>
                ...
                if(isset($_POST['ok']))
                {
                    ...
                    if($err)
                    {
                        ...
                        extract($_POST);
                        $check = mysqli_query($conn,"SELECT * FROM driver WHERE phno = '$phno' AND lic = '$lic'");
                        if(mysqli_num_rows($check)>0){
                            # user is valid
                            # fetch user data
                            $user_data = mysqli_fetch_array($check);
                            $_SESSION['driver'] = $driver_data;
                            ?>
                            <script>
...
<!--                                    </div>-->
            ...
            <div class="col-lg-4">
                ...
                <h2>Don't worry</h2>
                <br><br><br><br>
                <h1 style="font-size: 50pt; "><a href="driver_register.php">Register</a> now.</h1>
            </div>
        </div>
    </div>
</section>
